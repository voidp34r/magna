        ...
        if (set_value('ABERTO') == 1 || !set_value('ID'))
        {
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <?= form_input('RG', set_value('RG'), 'id="RG" maxlength="9" class="numbersOnly" required '); ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                	<label for="TPCONTA">Tipo da Conta *</label>
                    <?= form_dropdown('TP_CONTA', $TP_CONTAS, set_value('TP_CONTA'),'required'); ?>
                </div>
            </div>
            <hr>
            <?php
