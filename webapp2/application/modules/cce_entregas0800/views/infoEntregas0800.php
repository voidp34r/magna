        ...
        <div class="panel-body">
            <form action="cce_entregas0800/infoEntregas0800/1">
                <div class="row">
                    ...
                    <?php if($FILTRO_CENTRAL)  {?>
                        <div id="EMPRESA" class="col-sm-8" style="margin-top: 10px">
                            <label for="EMPRESA">Filial Destino</label>
                            <?=  form_multiselect('CDEMPRESA[]', $filiais, set_value('CDEMPRESA')); ?>
                        </div>
                    <?php }?>
                </div>
            </form>
