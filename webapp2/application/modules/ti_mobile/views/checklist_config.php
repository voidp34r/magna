                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">  
                                <div class="scrollit" align="center" style="height : 200px">
                                    <ul id="sortable" style="margin-left : 25px"></ul>
                                </div>
                            </div>
                            <div class="row" align="center">
                                <button  style="margin-top:10px;margin-left: 28px" class="btn btn-success" onclick="atualizaSequencia()">
                                        Salvar Sequencia
                                </button>  
                            </div>
                        </div>
...
<script>
    ...
    function setSequencia(dados){
        ...
        for(index in dados){
          ...
          $('#sortable').append('<li class="ui-state-default" seq="'+dados[index].SEQUENCIA+'" id="'+dados[index].ID+'">'+dados[index].NOME.toUpperCase()+'</li>');
        }
    ...
    function atualizaSequencia(){
        ...
        $.post('ti_mobile/atualiza_checklist_sequencia',objPost,function(retorno){
