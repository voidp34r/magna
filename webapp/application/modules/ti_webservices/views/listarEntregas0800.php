            ...
            <tbody><?php
                foreach ($lista as $item) {?>
                    <tr>
                        ...
                        <td><?= empty($item->DHINI) ? '' : convertTime($item->DHINI)?></td>
                        <td><?= empty($item->DHFIM) ? '' : convertTime($item->DHFIM) ?></td>
                        <td><?= empty($item->DHFIM) ? 'Processando' : compareTwoDate(convertTime($item->DHINI), convertTime($item->DHFIM)).' s'; ?></td>
                        <td align="center"><?php
