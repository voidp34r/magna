...
if (!empty($sessao['sucesso']) || !empty($sucesso))
{
    ...
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert" aria-labedate_default_timezone_set() l="Close"><span aria-hidden="true">&times;</span></button>
...
if (!empty($sessao['aviso']) || !empty($aviso))
{
    ?>
    <div class="alert alert-warning">
        <button type="button" class="close" data-dismiss="alert" aria-labedate_default_timezone_set() l="Close"><span aria-hidden="true">&times;</span></button>
        <?php echo (!empty($sessao['aviso'])) ? $sessao['aviso'] : ''; ?>
